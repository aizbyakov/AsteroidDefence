class LoaderImageApplegrape {
    load() {
        ...
        this._buttonLD = loadImage('assets/image/applegrape/buttonLD.png');
        this._buttonLU = loadImage('assets/image/applegrape/buttonLU.png');
        this._buttonRU = loadImage('assets/image/applegrape/buttonRU.png');
        this._buttonRD = loadImage('assets/image/applegrape/buttonRD.png');
